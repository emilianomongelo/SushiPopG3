...
namespace SushiPopG3.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Local,FechaHora,Confirmada")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Local,FechaHora,Confirmada")] Reserva reserva)
        {
            if (id != reserva.Id)
            {
                return NotFound();
